    ...
    <div class="sb-sidenav-menu">
        <div class="nav">
            ...
            @if (Auth::user()->type == 7)
                ...
                <div class="collapse" id="collapseTransactions" aria-labelledby="headingOne"
                    data-parent="#sidenavAccordion">
                    <nav class="sb-sidenav-menu-nested nav">
                        <a class="nav-link" href="{{ route('create-transaction') }}">Create Transaction</a>
                        <a class="nav-link" href="{{ route('get-transactions-list') }}">Transactions List</a>
            ...
            @if (in_array('laboratory_management', $data['permissions']))
                @if (Auth::user()->type == 9)
                    ...
                    <a class="nav-link" href="{{ route('lab-results-list') }}">
                        <div class="sb-nav-link-icon"><i class="fas fa-vials"></i></div>
                        Lab Results
                    </a>
                    <a class="nav-link" href="{{ route('new-lab-result') }}">
                        <div class="sb-nav-link-icon"><i class="fas fa-file-medical"></i></div>
                        Create Lab Result
                    </a>
                @else
                    <a class="nav-link collapsed" href="#" data-toggle="collapse"
                        data-target="#collapseLaboratory" aria-expanded="false" aria-controls="collapseLaboratory">
                        <div class="sb-nav-link-icon"><i class="fas fa-microscope"></i></div>
                        Laboratory
                        <div class="sb-sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
                    </a>
                    <div class="collapse" id="collapseLaboratory" aria-labelledby="headingOne"
                        data-parent="#sidenavAccordion">
                        <nav class="sb-sidenav-menu-nested nav">
            ...
            @endif --}}
            @if (Auth::user()->type == 1 || Auth::user()->type == 4 || Auth::user()->type == 8)
            ...
            @if (in_array('accounting', $data['permissions']))
                <a class="nav-link collapsed" href="#" data-toggle="collapse"
                    data-target="#collapseAccounting" aria-expanded="false" aria-controls="collapseAccounting">
                    <div class="sb-nav-link-icon"><i class="fas fa-coins"></i></div>
                    Accounting
                    <div class="sb-sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
                </a>
                <div class="collapse" id="collapseAccounting" aria-labelledby="headingOne"
                    data-parent="#sidenavAccordion">
                    <nav class="sb-sidenav-menu-nested nav">
            ...
            @if (in_array('user_accounts', $data['permissions']))
                ...
                <div class="collapse" id="collapseUsers" aria-labelledby="headingOne"
                    ...
                    <nav class="sb-sidenav-menu-nested nav">
                        ...
                        <a class="nav-link" href="{{ route('get-specialization-list') }}">Specialization</a>
