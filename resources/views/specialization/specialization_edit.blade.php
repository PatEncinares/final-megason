...
<main>
    <div class="container-fluid" id="app">
        <h1 class="mt-4"><img class="card-img-top img-thumbnail" style="height: 60px; width : 60px" src="{{ asset('assets/quick_links/settings.JPG') }}" alt="Patient Management">Specialization</h1>
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('update-specialization') }}" aria-label="{{ __('Create specialization') }}" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input type="text" name="specialization_name" id="" class="form-control" value="{{ $data['specialization']->name }}" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <textarea name="description" id="description" class="form-control" rows="3" required>{{ $data['specialization']->description }}</textarea>
                        </div>
                    </div>
